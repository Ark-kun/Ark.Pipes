...
namespace Ark.Animation { //.Pipes {
    public class CurveMovement {
        ...
        public static Provider<TResult> Create<TResult, T1, T2>(Func<Tuple<T1, T2>, TFloat, TResult> curve, Provider<Tuple<T1, T2>> parameters, Provider<TFloat> time) {
            return Provider<TResult>.Create((p, t) => curve(p, t), parameters, time);
        }
        ...
        public static Provider<TResult> Create<TResult, T1, T2, T3>(Func<Tuple<T1, T2, T3>, TFloat, TResult> curve, Provider<Tuple<T1, T2, T3>> parameters, Provider<TFloat> time) {
            return Provider<TResult>.Create((p, t) => curve(p, t), parameters, time);
        }
        ...
        public static Provider<TResult> Create<TResult, T1, T2, T3, T4>(Func<Tuple<T1, T2, T3, T4>, TFloat, TResult> curve, Provider<Tuple<T1, T2, T3, T4>> parameters, Provider<TFloat> time) {
            return Provider<TResult>.Create((p, t) => curve(p, t), parameters, time);
        }
        ...
        public static Provider<TResult> CreateStatic<TResult, T1, T2>(Func<T1, T2, TFloat, TResult> curve, T1 param1, T2 param2, Provider<TFloat> time) {
            return Provider<TResult>.Create((t) => curve(param1, param2, t), time);
        }
